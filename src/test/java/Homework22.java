...
public class Homework22 extends BaseTest {
    ...
    public void renamePlaylist() throws InterruptedException {
        ...
        String newPlaylistName = "cloud";
        String updatedPlaylistMsg = "Updated playlist \"" + "cloud." + "\"";
        ...
        Assert.assertEquals(actualMessage, updatedPlaylistMsg, "Updated playlist cloud");
    }
