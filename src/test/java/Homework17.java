...
public class Homework17 extends BaseTest {
    ...
    public void addSongToPlaylist() throws InterruptedException {
        // This test will only work successfully if the song being added is not already in the playlist.
        // If it is already in the playlist, delete and recreate the playlist.
        navigateToPage();
        provideEmail(email);
